 ...
 */
exports.validateEntityAcl = function(user, role, entity, validator) {
  var def = Q.defer();
  ...
  else if (typeof entity[validator] !== 'function') def.reject(entity.constructor.name + ' doesn\'t have validateACL method')
  else {
