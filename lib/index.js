...
console.log('before next in validateRouts');
		next();
	}
	catch (err) {
		next(err);
...
internals.getRouteParams = function(request) {
	...
	//console.log('request.route.plugins[pluginName] = ');
	//console.log(request.route);

	//console.log('request.plugins[pluginName] = ');
	//console.log(request.plugins);
	//console.log(request);
